...
class JackTokenizer:
    ...
    def tokenType(self):
        ...
        if tokenType:
            if self.DEBUG:
                print("{} is a {}".format(self.currentToken, tokenType))
            return tokenType
    ...
    def keyWord(self):
        ...
        if self.tokenizerFile:
            self.tokenizerFile.write("  <keyword>" + self.currentToken + "</keyword>\n")
    ...
    def symbol(self):
        ...
        assert self.tokenType() == "symbol", "Current token is not a symbol: " + token
        ...
        if self.tokenizerFile:
            ...
            self.tokenizerFile.write("  <symbol>" + qtoken + "</symbol>\n")
        return token
    ...
    def identifier(self):
        ...
        if self.tokenizerFile:
            self.tokenizerFile.write(
                "  <identifier>" + self.currentToken + "</identifier>\n"
            )
        return self.currentToken
    ...
    def intVal(self):
        ...
        if self.tokenizerFile:
            self.tokenizerFile.write(
                "  <integerConstant>" + self.currentToken + "</integerConstant>\n"
            )
        return intVal
    ...
    def stringVal(self):
        ...
        if self.tokenizerFile:
            self.tokenizerFile.write(
                "  <stringConstant>" + strVal + "</stringConstant>\n"
            )
        return strVal
